export const dict = {
  ...
  "dialog.provider.xai.note": "Access xAI Grok models with OAuth or API key",
  ...
  "provider.connect.opencodeZen.visit.link": "shob.ai/zen",
  ...
  "provider.custom.error.apiKey.required": "API key is required",
  "provider.custom.error.required": "Required",
  "provider.custom.error.duplicate": "Duplicate",

  "provider.openaiCompatible.title": "OpenAI Compatible",
  "provider.openaiCompatible.description": "Connect a provider with an OpenAI-compatible models endpoint.",
  "provider.openaiCompatible.fetchModels": "Fetch models",
  "provider.openaiCompatible.fetching": "Fetching...",
  "provider.openaiCompatible.models.label": "Fetched models",
  "provider.openaiCompatible.fetch.success.title": "Models fetched",
  "provider.openaiCompatible.fetch.success.description": "{{count}} models are ready to connect.",
  "provider.openaiCompatible.fetch.error.title": "Could not fetch models",
  "provider.openaiCompatible.error.fetchFirst": "Fetch models before saving this provider.",
  "provider.openaiCompatible.error.noModelsSelected": "Select at least one model.",
  "provider.anthropicCompatible.description": "Connect a provider that supports the Anthropic Messages API. Shob will send the API key as x-api-key and use the Anthropic request format.",
  ...
  "session.tab.add": "New tab",
  "session.panel.reviewAndFiles": "Review and files",
  "dialog.addTab.title": "New tab",
  "dialog.addTab.search.placeholder": "Search tabs…",
  "dialog.addTab.empty": "No tabs available",
  "dialog.addTab.review.title": "Review",
  "dialog.addTab.review.description": "Diff review for the current session",
  "dialog.addTab.context.title": "Context",
  "dialog.addTab.context.description": "Open a session as a context tab",
  "dialog.addTab.terminal.title": "Terminal",
  "dialog.addTab.terminal.description": "Open a terminal inside the review panel",
