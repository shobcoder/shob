import type { SnapshotFileDiff } from "@shob/sdk/v2"
...
export namespace TimelineRow {
  ...
  export class Thinking extends Data.TaggedClass("Thinking")<{
    userMessageID: string
    /** Live status label, e.g. "Editing packages/app/foo.ts". */
    activityTitle: string
    /** Short verb for shimmer, e.g. "Editing". */
    activityVerb: string
    /** File path / target shown in mono next to the verb. */
    activityPath?: string
    activityKind: string
