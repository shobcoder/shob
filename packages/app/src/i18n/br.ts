export const dict = {
  ...
  "dialog.provider.shobGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.provider.azure.note": "Modelos de IA de nível empresarial hospedados no Microsoft Azure",
  "dialog.provider.alibaba.note": "Modelos Qwen e outros via Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Shob",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Shob.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Shob.",
  ...
  "dialog.plugins.empty": "Plugins configurados em shob.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Shob este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Shob ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Shob",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (shob.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Shob ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Shob inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Shob dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Shob",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Shob aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Shob segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Shob é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Shob iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Shob.",
