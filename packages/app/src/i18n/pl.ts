export const dict = {
  ...
  "dialog.provider.shob.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.shob.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.shobGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.provider.azure.note": "Modele AI klasy przedsiębiorstwa hostowane na Microsoft Azure",
  "dialog.provider.alibaba.note": "Modele Qwen i inne przez Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Shob",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Shob.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.shobZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.shobZen.visit.prefix": "Odwiedź ",
  "provider.connect.shobZen.visit.link": "shob.olova.dev/zen",
  "provider.connect.shobZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Shob.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w shob.json",
  ...
  "dialog.server.description": "Przełącz serwer Shob, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Shob ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Shob",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (shob.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Shob zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Shob",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Shob na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Shob ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Shob.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Shob",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Shob.",
