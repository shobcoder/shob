...
export const dict = {
  ...
  "dialog.provider.shob.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.shob.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.shobGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.provider.azure.note": "Auf Microsoft Azure gehostete KI-Modelle für Unternehmen",
  "dialog.provider.alibaba.note": "Qwen- und andere Modelle über Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Shob",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Shob zu nutzen.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.shobZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.shobZen.visit.link": "shob.olova.dev/zen",
  "provider.connect.shobZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Shob zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Shob zu nutzen.",
  ...
  "dialog.plugins.empty": "In shob.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Shob-Server, mit dem sich diese App verbindet.",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (shob.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Shob unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Shob enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Shob-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Shob ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Shob auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Shob dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Shob anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Shob automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Shob.",
