export const dict = {
  ...
  "dialog.provider.shob.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.shob.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.shobGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.provider.azure.note": "نماذج ذكاء اصطناعي للمؤسسات مستضافة على Microsoft Azure",
  "dialog.provider.alibaba.note": "نماذج Qwen وغيرها عبر Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Shob",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Shob.",
  ...
  "provider.connect.shobZen.line1":
    "يمنحك Shob Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Shob.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في shob.json",
  ...
  "dialog.server.description": "تبديل خادم Shob الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Shob ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (shob.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Shob لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Shob نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Shob داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Shob",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Shob على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Shob يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Shob.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Shob",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Shob.",
