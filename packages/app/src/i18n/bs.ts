export const dict = {
  ...
  "dialog.provider.shob.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.shob.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.shobGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.provider.azure.note": "AI modeli poslovnog nivoa hostovani na Microsoft Azure",
  "dialog.provider.alibaba.note": "Qwen i drugi modeli putem Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Shob",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Shob-u.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Shob-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Shob-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u shob.json",
  ...
  "dialog.server.description": "Promijeni na koji se Shob server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Shob-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Shob timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (shob.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Shob još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Shob uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Shob server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Shob-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Shob izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Shob prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Shob-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Shob pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Shob-a.",
