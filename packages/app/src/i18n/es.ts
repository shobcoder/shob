export const dict = {
  ...
  "dialog.provider.shob.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.shob.tagline": "Modelos optimizados y fiables",
  "dialog.provider.shobGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.provider.azure.note": "Modelos de IA de nivel empresarial alojados en Microsoft Azure",
  "dialog.provider.alibaba.note": "Modelos Qwen y otros a través de Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Shob",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Shob.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.shobZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.shobZen.visit.prefix": "Visita ",
  "provider.connect.shobZen.visit.link": "opencode.ai/zen",
  "provider.connect.shobZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Shob.",
  ...
  "dialog.plugins.empty": "Plugins configurados en shob.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Shob se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Shob ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Shob",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (shob.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Shob no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Shob incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Shob dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Shob",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Shob en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Shob sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Shob.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Shob",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Shob.",
