...
export const dict = {
  ...
  "dialog.provider.shob.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.shob.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.shobGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.provider.azure.note": "Microsoft Azure'da barındırılan kurumsal düzeyde yapay zekâ modelleri",
  "dialog.provider.alibaba.note": "Alibaba Cloud Model Studio üzerinden Qwen ve diğer modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Shob tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Shob'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.shobZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Shob'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Shob'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler shob.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Shob sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Shob'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Shob ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (shob.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Shob henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Shob ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Shob Masaüstü",
  ...
  "settings.desktop.wsl.description": "Shob sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Shob'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Shob'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Shob'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Shob'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Shob başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Shob'un en son sürümünü kullanıyorsunuz.",
