export const dict = {
  ...
  "dialog.provider.shob.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.shob.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.shobGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.provider.azure.note": "Virksomhedsrettede AI-modeller hostet på Microsoft Azure",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Shob",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Shob.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Shob.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i shob.json",
  ...
  "dialog.server.description": "Skift hvilken Shob-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Shob ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Shob-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (shob.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Shob understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Shob inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Shob-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Shob",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Shob ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Shob følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Shob er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Shob starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Shob.",
