export const dict = {
  ...
  "dialog.provider.shob.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.shob.tagline": "Reliable optimized models",
  "dialog.provider.shobGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.provider.azure.note": "Enterprise-grade AI models hosted on Microsoft Azure",
  "dialog.provider.alibaba.note": "Qwen and other models via Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Shob",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Shob.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.shobZen.line1":
    "Shob Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.shobZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.shobZen.visit.prefix": "Visit ",
  "provider.connect.shobZen.visit.link": "shob.olova.dev/zen",
  "provider.connect.shobZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Shob.",
  ...
  "dialog.plugins.empty": "Plugins configured in shob.json",
  ...
  "dialog.server.description": "Switch which Shob server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Shob...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Shob in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Shob...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Shob in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Shob in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Shob",
  "wsl.onboarding.shobReadyIn": "Shob is ready in {{distro}}.",
  "wsl.onboarding.shobReady": "Shob is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Shob in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Shob",
  ...
  "wsl.onboarding.distroStatus.shobMissing": "Shob not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Shob can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Shob could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Shob.",
  ...
  "toast.update.description": "A new version of Shob ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Shob team",
  ...
  "error.chain.checkConfig": "Check your config (shob.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Shob does not support MCP authentication yet.',
  ...
  "home.title": "Home",
  "home.welcome.title": "Ready when you are",
  "home.welcome.description": "Search past sessions or start something new",
  ...
  "sidebar.gettingStarted.line1": "Shob includes free models so you can start immediately.",
  ...
  "settings.skills.description":
    "Install built-in skills for the agent. Installed skills are available in sessions; uninstall removes managed ones from your skill store.",
  "settings.skills.search.placeholder": "Search skills",
  "settings.skills.loading": "Loading skills…",
  "settings.skills.empty": "No skills are available yet.",
  "settings.skills.empty.filter": "No skills match",
  "settings.skills.empty.available": "All built-in skills are installed.",
  "settings.skills.count": "{{count}} skills",
  "settings.skills.installedCount": "{{count}} installed",
  "settings.skills.section.installed": "Installed",
  "settings.skills.section.available": "Available",
  "settings.skills.action.install": "Install",
  "settings.skills.action.uninstall": "Uninstall",
  "settings.skills.badge.installed": "Installed",
  "settings.skills.badge.managed": "Managed",
  "settings.skills.desktopOnly": "Skill install is available in the desktop app.",
  "settings.skills.toast.installed.title": "Skill installed",
  "settings.skills.toast.installed.description": "{{name}} is now available in sessions.",
  "settings.skills.toast.installFailed.title": "Install failed",
  "settings.skills.toast.uninstalled.title": "Skill uninstalled",
  "settings.skills.toast.uninstalled.description": "{{name}} was removed from your skill store.",
  "settings.skills.toast.uninstallFailed.title": "Uninstall failed",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the Shob server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Shob",
  ...
  "settings.general.row.appearance.description": "Customise how Shob looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Shob follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Shob is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Shob launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Shob.",
