...
export const dict = {
  ...
  "dialog.provider.shob.note": "使用 Shob Zen 或 API 密钥连接",
  "dialog.provider.shob.tagline": "可靠的优化模型",
  "dialog.provider.shobGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.provider.azure.note": "Microsoft Azure 上托管的企业级 AI 模型",
  "dialog.provider.alibaba.note": "通过阿里云百炼使用通义千问等模型",
  ...
  "dialog.model.unpaid.freeModels.title": "Shob 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Shob 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Shob 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Shob 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 shob.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Shob 服务器。",
  ...
  "toast.update.description": "Shob 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Shob 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (shob.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Shob 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Shob 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Shob 服务器。",
  ...
  "settings.general.row.language.description": "更改 Shob 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Shob 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Shob 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Shob 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Shob 启动时自动检查更新",
