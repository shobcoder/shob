...
export const dict = {
  ...
  "dialog.provider.shob.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.shob.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.shobGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.provider.azure.note": "Bedriftsrettede AI-modeller hostet på Microsoft Azure",
  "dialog.provider.alibaba.note": "Qwen og andre modeller via Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Shob",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Shob.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.shobZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.shobZen.visit.prefix": "Besøk ",
  "provider.connect.shobZen.visit.link": "shob.olova.dev/zen",
  "provider.connect.shobZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Shob.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i shob.json",
  ...
  "dialog.server.description": "Bytt hvilken Shob-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Shob ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Shob-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (shob.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Shob ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Shob inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Shob-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Shob",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Shob ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Shob skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Shob er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Shob starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Shob.",
