export const dict = {
  ...
  "dialog.provider.shob.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.shob.tagline": "Modèles optimisés et fiables",
  "dialog.provider.shobGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.provider.azure.note": "Modèles d'IA de niveau entreprise hébergés sur Microsoft Azure",
  "dialog.provider.alibaba.note": "Modèles Qwen et autres via Alibaba Cloud Model Studio",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Shob",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Shob.",
  ...
  "provider.connect.shobZen.line1":
    "Shob Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.shobZen.visit.prefix": "Visitez ",
  "provider.connect.shobZen.visit.link": "opencode.ai/zen",
  "provider.connect.shobZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Shob.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Shob.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans shob.json",
  ...
  "dialog.server.description": "Changez le serveur Shob auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Shob ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Shob",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (shob.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Shob ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Shob inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Shob dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Shob",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Shob sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Shob suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Shob.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Shob",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Shob.",
