...
import { useSpring } from "@shob/ui/motion-spring"
import {
  createEffect,
  on,
  Component,
...
import { DockShellForm, DockTray } from "@shob/ui/dock-surface"
...
import { KeybindV2 } from "@shob/ui/v2/keybind-v2"
...
import type { ReferenceInfo } from "@shob/sdk/v2/client"
...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  createEffect(() => {
    const handleBrowserElementSelected = (event: Event) => {
      ...
      prompt.set([...prompt.current(), attachment], cursor + attachment.content.length)
    ...
    window.addEventListener("opencode-browser-element-selected", handleBrowserElementSelected)
    onCleanup(() => window.removeEventListener("opencode-browser-element-selected", handleBrowserElementSelected))
  })
              ...
              >
                ...
                >
                  <div
                    ...
                    classList={{
                      "select-text": true,
                      "min-h-[52px] w-full px-6 pt-5 pb-3 focus:outline-none whitespace-pre-wrap leading-[1.5] text-[14px] font-[440] text-v2-text-text-base": true,
                      "[&_[data-type=file]]:text-syntax-property [&_[data-type=file]]:bg-v2-background-bg-weak [&_[data-type=file]]:px-1.5 [&_[data-type=file]]:py-0.5 [&_[data-type=file]]:rounded": true,
                      "[&_[data-type=agent]]:text-syntax-type [&_[data-type=agent]]:bg-v2-background-bg-weak [&_[data-type=agent]]:px-1.5 [&_[data-type=agent]]:py-0.5 [&_[data-type=agent]]:rounded": true,
                      "font-mono!": store.mode === "shell",
                    }}
                  />
                  <div
                    data-component={newSession() ? "session-new-design-text" : "session-composer-text"}
                    class="absolute top-0 inset-x-0 px-6 pt-5 pointer-events-none whitespace-nowrap truncate leading-[1.5] text-[14px] font-[440] text-v2-text-text-faint [font-family:var(--font-family-sans)]"
          ...
          <div class="flex flex-col gap-3 w-full">
            ...
            >
              ...
              >
                ...
                <div class="pointer-events-none absolute bottom-0 inset-x-0 pb-2 px-2 flex items-center justify-between gap-2">
                  <input
                    ref={fileInputRef}
                    type="file"
                    multiple
