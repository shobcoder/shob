...
beforeAll(async () => {
  ...
  mock.module("@shob/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@shob/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@shob/ui/icon", () => ({ Icon: () => null }))
  mock.module("@shob/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
