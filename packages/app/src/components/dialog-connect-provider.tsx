import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@shob/sdk/v2/client"
import { Button } from "@shob/ui/button"
import { useDialog } from "@shob/ui/context/dialog"
import { Dialog, DialogBody, DialogHeader } from "@shob/ui/v2/dialog-v2"
import { Icon } from "@shob/ui/icon"
import { IconButton } from "@shob/ui/icon-button"
import { List, type ListRef } from "@shob/ui/list"
...
export function DialogConnectProvider(props: { provider: string; directory?: Accessor<string | undefined> }) {
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.shobZen.line1")}</div>
  ...
  return (
    <Dialog>
      ...
      <DialogBody>
        <div class="px-2.5 pb-10 flex flex-col gap-6 pt-6">
