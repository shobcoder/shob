import { AppIcon } from "@shob/ui/app-icon"
...
export function SessionHeader() {
  ...
  onMount(() => {
    setCenterMount(document.getElementById("shob-titlebar-center"))
    setRightMount(document.getElementById("shob-titlebar-right"))
  })
