...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Shob Documentation", href: "https://github.com/shobcoder/shob/issues" },
      { type: "item", label: "Support Forum", href: "https://github.com/shobcoder/shob/issues" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/shobcoder/shob/issues",
      },
      {
        type: "item",
        label: "Report a Bug",
