...
import { FileSystemWatcher } from "@shob/schema/filesystem-watcher"
...
declare const SHOB_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof SHOB_LIBC === "undefined" ? undefined : SHOB_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@shob/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.SHOB_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.SHOB_EXPERIMENTAL_FILEWATCHER) {
