...
export class Service extends Context.Service<Service, Interface>()("@shob/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.SHOB_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
