...
import { Event } from "@shob/schema/project-directories"
import { ProjectCopy } from "@shob/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@shob/ProjectCopy") {}
