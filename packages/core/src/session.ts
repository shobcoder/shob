...
import { ListAnchor } from "@shob/schema/session"
...
import { SessionDurable } from "@shob/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@shob/v2/Session") {}
