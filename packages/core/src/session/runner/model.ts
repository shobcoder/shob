...
import { type Model } from "@shob/llm"
import * as AnthropicMessages from "@shob/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@shob/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@shob/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@shob/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@shob/v2/SessionRunnerModel") {}
