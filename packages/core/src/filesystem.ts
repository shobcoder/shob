...
import { Entry, FileSystem, FindInput, Match } from "@shob/schema/filesystem"
export { Entry, Match, Submatch } from "@shob/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@shob/v2/FileSystem") {}
