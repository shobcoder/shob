...
import type { AssistantMessage, FilePart, UserMessage } from "@shob/sdk/v2"
...
import { SHOB_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpencodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.SHOB_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  return (
    <>
      <box ref={(r: BoxRenderable) => (anchor = r)} visible={props.visible !== false} width="100%">
        <Show
          when={props.variant !== "home"}
          fallback={
            <box width="100%" flexDirection="row" alignItems="flex-start" gap={1}>
              <text fg="#f43f5e" attributes={TextAttributes.BOLD}>
                {">"}
              </text>
        ...
        >
          <box width="100%" flexDirection="row" alignItems="flex-start" gap={1}>
            ...
            <box flexGrow={1} width="100%">
              <textarea
                width="100%"
                placeholder={placeholderText() || "Ask your question..."}
              ...
              <box flexDirection="row" flexShrink={0} paddingTop={1} gap={1} justifyContent="space-between">
                <box flexDirection="row" gap={1}>
                  <text fg={theme.textMuted}>/help for shortcuts</text>
                </box>
