...
import defaultSoundPath from "@shob/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@shob/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@shob/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@shob/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@shob/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@shob/ui/audio/yup-01.mp3" with { type: "file" }
