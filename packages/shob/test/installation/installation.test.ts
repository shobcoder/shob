...
import { makeGlobalNode } from "@shob/core/effect/app-node"
...
import { InstallationChannel } from "@shob/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("shobcoder/tap/shob")) return ""
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("shobcoder/tap/shob") && args.includes("--formula")) return "opencode"
