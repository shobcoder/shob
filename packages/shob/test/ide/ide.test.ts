...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SHOB_CALLER", () => {
    process.env["SHOB_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SHOB_CALLER", () => {
    process.env["SHOB_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SHOB_CALLER", () => {
    process.env["SHOB_CALLER"] = "unknown"
