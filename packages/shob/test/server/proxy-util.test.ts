...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips shob-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-shob-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-shob-directory")).toBeNull()
      expect(result.get("x-shob-workspace")).toBeNull()
