 ...
 *   "@shob/ServerAuthConfig",
 *   {
 *     password: Config.string("SHOB_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SHOB_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
