...
import { ProjectDirectoryTable, ProjectTable } from "@shob/core/project/sql"
import { ProjectDirectories } from "@shob/core/project/directories"
...
import { which } from "@shob/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@shob/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.SHOB_FAKE_VCS)
