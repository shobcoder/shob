...
import { Hash } from "@shob/core/util/hash"
...
import { optional } from "@shob/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@shob/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
