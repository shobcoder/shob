import type { JsonSchema, LLMRequest, ProviderMetadata } from "@shob/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@shob/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @shob/llm request objects from shob's session/AI SDK-shaped data.
  return LLM.request({
