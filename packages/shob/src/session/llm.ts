...
import { llmClient } from "@shob/core/effect/app-node-platform"
...
import type { LLMEvent } from "@shob/llm"
import { LLMClient } from "@shob/llm/route"
import type { LLMClientService } from "@shob/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @shob/llm. It
