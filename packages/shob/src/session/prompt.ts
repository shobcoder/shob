...
import { MAX_STEPS_PROMPT } from "@shob/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@shob/SessionPrompt") {}
