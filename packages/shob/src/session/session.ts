...
import { locationServiceMapLayer } from "@shob/core/location-services"
...
import { PartTable, SessionTable } from "@shob/core/session/sql"
...
import { NonNegativeInt, optional } from "@shob/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".shob", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@shob/Session") {}
