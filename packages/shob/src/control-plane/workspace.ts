...
import { EventSequenceTable, EventTable } from "@shob/core/event/sql"
...
import { WorkspaceEvent } from "@shob/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@shob/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SHOB_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SHOB_WORKSPACE_ID: config.id,
        SHOB_EXPERIMENTAL_WORKSPACES: "true",
