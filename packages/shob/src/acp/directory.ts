...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@shob/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@shob/ACPDirectory") {}
