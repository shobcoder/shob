...
export class Service extends Context.Service<Service, Interface>()("@shob/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __SHOB_PHOTON_WASM_PATH?: string }).__SHOB_PHOTON_WASM_PATH =
