...
import { hasTheme, upsertTheme } from "@shob/tui/context/theme"
import { Global } from "@shob/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@shob/core/util/flock"
import { Flag } from "@shob/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@shob/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@shob/core/v1/config/plugin"
import { createCommandShim } from "@shob/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@shob/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.SHOB_PURE ? [] : pluginOrigins
    if (Flag.SHOB_PURE && pluginOrigins.length) {
    }
