...
import type { Model } from "@shob/sdk/v2"
import { InstallationVersion } from "@shob/core/installation/version"
import { OauthCallbackPage } from "@shob/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Shob will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
