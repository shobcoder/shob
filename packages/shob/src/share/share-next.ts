...
import type * as SDK from "@shob/sdk/v2"
...
import { SessionShareTable } from "@shob/core/share/sql"
import { ProviderV2 } from "@shob/core/provider"
import { ModelV2 } from "@shob/core/model"
import { EventV2 } from "@shob/core/event"

const disabled = process.env["SHOB_DISABLE_SHARE"] === "true" || process.env["SHOB_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@shob/ShareNext") {}
