...
import { path } from "@shob/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@shob/core/project"
...
import { WorktreeEvent } from "@shob/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@shob/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `shob/${name}`
