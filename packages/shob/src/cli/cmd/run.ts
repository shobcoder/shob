import type { PermissionV1 } from "@shob/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@shob/sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to SHOB_SERVER_USERNAME or 'opencode')",
      })
      .option("dir", {
        type: "string",
