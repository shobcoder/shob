...
- Effect plugins import `@shob/plugin/v2/effect`, not `@shob/core`.
- Public domain values use generated `@shob/sdk` types.
...
- Define `PluginHost` domain capabilities in `@shob/plugin/v2/effect`.
