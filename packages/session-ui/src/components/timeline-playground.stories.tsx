...
import { FileComponentProvider } from "@shob/ui/context/file"
...
function normalize(raw: unknown) {
  ...
  if (!record(raw) || !record(raw.info) || typeof raw.info.id !== "string" || !Array.isArray(raw.messages)) {
    throw new Error("Expected an `shob export` JSON file")
  }
...
const CSS_CONTROLS: CSSControl[] = [
  ...
  {
    key: "activity-tool-gap",
    label: "Activity tool gap",
    group: "Activity Group",
    type: "range",
    initial: "2",
    selector: '[data-component="tool-activity-group-list"]',
    property: "gap",
    min: "0",
    max: "40",
    step: "1",
    unit: "px",
    source: { file: MP, anchor: '[data-component="tool-activity-group-list"]', prop: "gap", format: px },
  },
  {
    key: "activity-tool-indent",
    label: "Activity indent",
    group: "Activity Group",
    type: "range",
    initial: "20",
    selector: '[data-component="tool-activity-group-list"]',
    ...
    step: "1",
    unit: "px",
    source: { file: MP, anchor: '[data-component="tool-activity-group-list"]', prop: "padding-left", format: px },
  },
  {
    key: "bash-max-height",
          ...
          <Show when={panels.generators}>
            <div style={{ padding: "0 12px 12px", display: "flex", "flex-direction": "column", gap: "6px" }}>
              ...
              <div style={{ "font-size": "10px", color: "var(--text-weaker)", "margin-bottom": "2px" }}>
                Replaces the current timeline with an `shob export` JSON file
              </div>
