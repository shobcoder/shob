...
digit roller for count transitions. Shown here with \`ToolStatusTitle\` as a
standalone animated status-summary example.`,
      },
    },
  },
}
  ...
  render: () => {
    ...
    return (
      <div style={{ display: "grid", gap: "24px", padding: "20px", "max-width": "520px" }}>
        ...
        {/* Status and count summary composition example. */}
        <span
