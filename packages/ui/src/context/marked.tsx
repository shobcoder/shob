...
/** Token-based shiki theme — colors resolve from the active desktop theme CSS vars. */
export const ShobTheme = {
  name: "Shob",
  bg: "var(--color-background-stronger, var(--background-stronger))",
  fg: "var(--text-base)",
  colors: {
    "editor.background": "var(--color-background-stronger, var(--background-stronger))",
...
registerCustomTheme("Shob", () => Promise.resolve(ShobTheme))
