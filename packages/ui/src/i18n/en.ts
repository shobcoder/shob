export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Shob Go for reliable access to the best open-source models, starting at $5/month.",
  ...
  "ui.toolActivity.edit.running.one": "Editing a file",
  "ui.toolActivity.edit.running.other": "Editing files",
  "ui.toolActivity.edit.done.one": "Edited a file",
  "ui.toolActivity.edit.done.other": "Edited files",
  "ui.toolActivity.command.running.one": "Running a command",
  "ui.toolActivity.command.running.other": "Running commands",
  "ui.toolActivity.command.done.one": "Ran a command",
  "ui.toolActivity.command.done.other": "Ran commands",
  "ui.toolActivity.explore.running.one": "Exploring code",
  "ui.toolActivity.explore.running.other": "Exploring code",
  "ui.toolActivity.explore.done.one": "Explored code",
  "ui.toolActivity.explore.done.other": "Explored code",
  "ui.toolActivity.web.running.one": "Searching the web",
  "ui.toolActivity.web.running.other": "Searching the web",
  "ui.toolActivity.web.done.one": "Searched the web",
  "ui.toolActivity.web.done.other": "Searched the web",
  "ui.toolActivity.task.running.one": "Delegating a task",
  "ui.toolActivity.task.running.other": "Delegating tasks",
  "ui.toolActivity.task.done.one": "Delegated a task",
  "ui.toolActivity.task.done.other": "Delegated tasks",
  "ui.toolActivity.question.running.one": "Asking a question",
  "ui.toolActivity.question.running.other": "Asking questions",
  "ui.toolActivity.question.done.one": "Asked a question",
  "ui.toolActivity.question.done.other": "Asked questions",
  "ui.toolActivity.skill.running.one": "Using a skill",
  "ui.toolActivity.skill.running.other": "Using skills",
  "ui.toolActivity.skill.done.one": "Used a skill",
  "ui.toolActivity.skill.done.other": "Used skills",
  "ui.toolActivity.tool.running.one": "Calling a tool",
  "ui.toolActivity.tool.running.other": "Calling tools",
  "ui.toolActivity.tool.done.one": "Called a tool",
  "ui.toolActivity.tool.done.other": "Called tools",
  "ui.toolActivity.item.command.running": "Running",
  "ui.toolActivity.item.command.done": "Ran",
  "ui.toolActivity.item.edit.running": "Editing",
  "ui.toolActivity.item.edit.done": "Edited",
  "ui.toolActivity.item.read.running": "Reading",
  "ui.toolActivity.item.read.done": "Read",
  "ui.toolActivity.item.list.running": "Listing",
  "ui.toolActivity.item.list.done": "Listed",
  "ui.toolActivity.item.search.running": "Searching",
  "ui.toolActivity.item.search.done": "Searched",
  "ui.toolActivity.item.fetch.running": "Fetching",
  "ui.toolActivity.item.fetch.done": "Fetched",
  "ui.toolActivity.item.web.running": "Searching the web",
  "ui.toolActivity.item.web.done": "Searched the web",
