...
import type { Definition } from "@shob/schema/event"
...
export const ShobEvent = event.schema
export type ShobEvent = typeof ShobEvent.Type
export type ShobEventEncoded = typeof ShobEvent.Encoded
