...
class Database extends Context.Service<Database, DatabaseShape>()("@shob/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@shob/example/UserStore") {
