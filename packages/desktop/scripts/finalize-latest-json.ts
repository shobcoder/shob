...
const releaseId = process.env.SHOB_RELEASE
if (!releaseId) throw new Error("SHOB_RELEASE is required")

const version = process.env.SHOB_VERSION
if (!version) throw new Error("SHOB_VERSION is required")
...
const macxTarGz = "shob-desktop-mac-x64.app.tar.gz"
const macaTarGz = "shob-desktop-mac-arm64.app.tar.gz"
