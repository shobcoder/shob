...
export const TypeId: TypeId = "~@shob/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@shob/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@shob/effect-sqlite-node/NodeSqliteClient")
