...
Generates UPCOMING_CHANGELOG.md by running the shob changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for shob run (default: low)
      --quiet            Suppress shob command output unless it fails
