...
Use this folder for locale-specific translation guidance that supplements `.shob/agent/translator.md`.
...
- PR #12345: https://github.com/shobcoder/shob/pull/12345

## Do Not Translate (Locale Additions)

- `Shob` (preserve casing)
