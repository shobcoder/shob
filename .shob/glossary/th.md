...
- PR #10809: https://github.com/shobcoder/shob/pull/10809
- PR #11496: https://github.com/shobcoder/shob/pull/11496

## Do Not Translate (Locale Additions)

- `Shob` (preserve casing in prose; keep `shob` only in commands, package names, paths, or code)
- `Shob CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
