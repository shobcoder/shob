...
- PR #15835: https://github.com/anomalyco/shob/pull/15835

## Do Not Translate (Locale Additions)

- `Shob` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `shob` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Shob` in prose, `shob` only for exact technical identifiers
...
- Avoid changing `shob` to `Shob` inside commands, URLs, package names, or code literals
