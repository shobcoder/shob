...
- `Shob` (preserve casing in prose; keep `shob` only when it is part of commands, package names, paths, or code)
- `Shob Zen`
- `Shob CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `shob` in prose when referring to the product name; use `Shob`
