...
Desktop application and browser-based app issues, including `shob web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core shob server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Shob Zen, Shob Go, and billing issues.
