...
interface InputGroupAddonProps extends VariantProps<typeof inputGroupAddonVariants> {
  class?: string
...
interface InputGroupButtonProps extends VariantProps<typeof inputGroupButtonVariants> {
  class?: string
...
function InputGroupTextarea(props: JSX.TextareaHTMLAttributes<HTMLTextAreaElement>) {
  return (
    <Textarea
      data-slot="input-group-control"
      class={cn(
